				...
				return (
					i(t, [
						...
						},
						{
							key: 'keepTyping',
							value(t, e, s) {
								e === 0 && (this.toggleBlinking(!1), this.options.preStringTyped(this.arrayPos, this)), (e += s);
					...
					o(t, [
						{
							...
							value(t, e, s) {
								if (
									(typeof s === 'string' ? (t.el = document.querySelector(s)) : (t.el = s),
									(t.options = { ...u.default, ...e }),
									...
									const n = Array.prototype.slice.apply(t.stringsElement.children);
									const i = n.length;
									if (i)
										for (var o = 0; o < i; o += 1) {
											const a = n[o];
							...
							value(t) {
								...
								if (t.autoInsertCss && (t.showCursor || t.fadeOut) && !document.querySelector(`[${e}]`)) {
									...
									t.showCursor &&
										...
										s.length !== 0 && ((s.innerHTML = n), document.body.appendChild(s));
								}
							}
						}
					]),
