...
!(function (a, b) {
		...
		r.extend({
			...
			isPlainObject(a) {
				...
				return (
					...
					(!(b = e(a)) || ((c = l.call(b, 'constructor') && b.constructor), typeof c === 'function' && m.call(c) === n))
				);
			},
			isEmptyObject(a) {
				let b;
	...
	const x = (function (a) {
		...
		function la(a, b) {
			let c = b && a;
			const d = c && a.nodeType === 1 && b.nodeType === 1 && a.sourceIndex - b.sourceIndex;
			if (d) return d;
							...
							: function (b, c, i) {
									...
									if (q) {
										...
										if (((o = [g ? q.firstChild : q.lastChild]), g && s)) {
											...
											while ((m = (++n && m && m[p]) || (t = n = 0) || o.pop()))
												if (
													(h ? m.nodeName.toLowerCase() === r : m.nodeType === 1) &&
													++t &&
	...
	const da = function (a, b) {
		return (
			(a = b || a), a.style.display === 'none' || (a.style.display === '' && r.contains(a.ownerDocument, a) && r.css(a, 'display') === 'none')
		);
	};
		...
		for (var c, d, e = [], f = 0, g = a.length; f < g; f++)
			(d = a[f]),
				d.style &&
					((c = d.style.display),
					b
						? (c === 'none' && ((e[f] = W.get(d, 'display') || null), e[f] || (d.style.display = '')),
	...
	function ya(a, b, c, d, e, f) {
		...
		if (
			(d == null && e == null
				? ((e = c), (d = c = void 0))
				: e == null && (typeof c === 'string' ? ((e = d), (d = void 0)) : ((e = d), (d = c), (c = void 0))),
			e === !1)
		)
			e = wa;
		else if (!e) return a;
			...
			function (a, b) {
				r.event.special[a] = {
					...
					handle(a) {
						...
						const f = a.handleObj;
						return (
							(e && (e === d || r.contains(d, e))) || ((a.type = f.origType), (c = f.handler.apply(this, arguments)), (a.type = b)), c
						);
					}
				};
			}
	...
	function Za(a, b, c, d, e) {
		...
		for (f = c === (d ? 'border' : 'content') ? 4 : b === 'width' ? 1 : 0; f < 4; f += 2)
			c === 'margin' && (g += r.css(a, c + ca[f], !0, e)),
				d
					? (c === 'content' && (g -= r.css(a, `padding${ca[f]}`, !0, e)), c !== 'margin' && (g -= r.css(a, `border${ca[f]}Width`, !0, e)))
					: ((g += r.css(a, `padding${ca[f]}`, !0, e)), c !== 'padding' && (g += r.css(a, `border${ca[f]}Width`, !0, e)));
		return g;
	}
	function $a(a, b, c) {
		let d;
				...
				return (
					...
					void 0 === c
						? g && 'get' in g && void 0 !== (e = g.get(a, !1, d))
							...
							: j[b]
						: ((f = typeof c),
						  f === 'string' && (e = ba.exec(c)) && e[1] && ((c = fa(a, b, e)), (f = 'number')),
						  c != null &&
								c === c &&
								(f === 'number' && (c += (e && e[3]) || (r.cssNumber[h] ? '' : 'px')),
		...
		r.each(['height', 'width'], function (a, b) {
			r.cssHooks[b] = {
				...
				set(a, c, d) {
					let e;
					const f = d && Na(a);
					const g = d && Za(a, b, d, r.css(a, 'boxSizing', !1, f) === 'border-box', f);
		...
		(_a.propHooks = {
			_default: {
				...
				set(a) {
					r.fx.step[a.prop]
						? r.fx.step[a.prop](a)
						: a.elem.nodeType !== 1 || (a.elem.style[r.cssProps[a.prop]] == null && !r.cssHooks[a.prop])
						? (a.elem[a.prop] = a.now)
	...
	function ib(a, b, c) {
		...
		if (((i = !r.isEmptyObject(b)), i || !r.isEmptyObject(n))) {
			l &&
				...
				(k = r.css(a, 'display')),
				k === 'none' && (j ? (k = j) : (ia([a], !0), (j = a.style.display || j), (k = r.css(a, 'display')), ia([a]))),
	...
	function kb(a, b, c) {
		...
		var i = function () {
			if (e) return !1;
			for (
				var b = ab || fb(), c = Math.max(0, j.startTime + j.duration - b), d = c / j.duration || 0, f = 1 - d, g = 0, i = j.tweens.length;
				g < i;
				g++
			)
				j.tweens[g].run(f);
		...
		var j = h.promise({
			...
			tweens: [],
			createTween(b, c) {
				const d = r.Tween(a, j.opts, b, c, j.opts.specialEasing[b] || j.opts.easing);
			...
			attr(a, b, c) {
				...
				if (f !== 3 && f !== 8 && f !== 2)
					return typeof a.getAttribute === 'undefined'
						? r.prop(a, b, c)
						: ((f === 1 && r.isXMLDoc(a)) || (e = r.attrHooks[b.toLowerCase()] || (r.expr.match.bool.test(b) ? lb : void 0)),
						  void 0 !== c
								? c === null
	...
	r.fn.extend({
		...
		r.extend({
			prop(a, b, c) {
				...
				if (f !== 3 && f !== 8 && f !== 2)
					return (
						(f === 1 && r.isXMLDoc(a)) || ((b = r.propFix[b] || b), (e = r.propHooks[b])),
						void 0 !== c
							? e && 'set' in e && void 0 !== (d = e.set(a, c, b))
								? d
								: (a[b] = c)
				...
				if (e)
					return (
						...
						b && 'get' in b && void 0 !== (c = b.get(e, 'value'))
							? c
							: ((c = e.value), typeof c === 'string' ? c.replace(rb, '') : c == null ? '' : c)
					);
			}
		}
	}),
								...
								c &&
									...
									a === 'abort'
										...
										: f(
												...
												h.statusText,
												(h.responseType || 'text') !== 'text' || typeof h.responseText !== 'string'
													? {
															binary: h.response
													  }
													: {
	...
	r.ajaxSetup({
			...
			const h =
				...
				(Ub.test(b.url)
					...
					: typeof b.data === 'string' &&
					  (b.contentType || '').indexOf('application/x-www-form-urlencoded') === 0 &&
					  Ub.test(b.data) &&
					  'data');
		...
		(r.fn.load = function (a, b, c) {
			...
			return (
				...
				r.isFunction(b) ? ((c = b), (b = void 0)) : b && typeof b === 'object' && (e = 'POST'),
				g.length > 0 &&
					r
						.ajax({
							url: a,
