...
const shortHandView = document.getElementById('shortHandView');
const shortHand = document.getElementById('shortHand');
const shortenButton = document.getElementById('shortenButton');
const copyURLTitle = document.getElementById('copyURLTitle');
const shortURLView = document.getElementById('shortURLView');
...
function copyShortLink() {
	...
	setTimeout(function () {
		urlSnackbar.className = urlSnackbar.className.replace('show', '');
	}, 3000);
}
...
async function shortenURL() {
	...
	const customURL = custom.checked;
	let shortHandValue;
	...
	if (customURL) {
		...
		if (originalURL != '' && shortHandValue == '') {
			if (mobile) {
				...
				setTimeout(function () {
					shortHandSnackbar.className = shortHandSnackbar.className.replace('show', '');
				}, 3000);
			}
		}
	}
